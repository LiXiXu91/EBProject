...
$(function (){
	...
	(function (){
		...
		var iH = 0;
		var arrData = [
			{ 'name':'许俪曦', 'time':4, 'title':'那些灿烂华美的瞬间', 'url':'#' },
			{ 'name':'许俪曦', 'time':5, 'title':'广东3天抓获涉黄疑犯', 'url':'#' },
			{ 'name':'许俪曦', 'time':6, 'title':'国台办回应王郁琦', 'url':'#' },
			{ 'name':'许俪曦', 'time':7, 'title':'那些灿烂华美的瞬间', 'url':'#' },
			{ 'name':'许俪曦', 'time':8, 'title':'那些灿烂华美的瞬间', 'url':'#' },
			{ 'name':'许俪曦', 'time':9, 'title':'广东3天抓获涉黄疑犯', 'url':'#' },
			{ 'name':'许俪曦', 'time':10, 'title':'国台办回应王郁琦', 'url':'#' },
			{ 'name':'许俪曦', 'time':11, 'title':'那些灿烂华美的瞬间', 'url':'#' }
		];
		var str = '';
